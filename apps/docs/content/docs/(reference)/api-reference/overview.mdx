...
>
  ...
  >
    ...
    />
    <Component
      name="ThreadPrimitive.Share"
      docsLink="#thread-primitive-share"
      tooltip="Shares the entire thread"
    />
...
>
  ...
  />
  <Component
    name="ActionBarPrimitive.Share"
    docsLink="#action-bar-primitive-share"
    tooltip="Shares the message"
  />
</Component>
...
- [`ThreadReadOnly`](#thread-read-only) - Read-only thread views for shared conversations
- [`serializeMessages`](#serialize-messages) - Convert ThreadMessage[] to JSON-safe format
- [`deserializeMessages`](#deserialize-messages) - Convert serialized messages back to ThreadMessage[]
- [`toMarkdown`](#to-markdown) - Export messages to Markdown format
- [`toJSON`](#to-json) - Export messages to JSON format

### Replay

- [`ThreadReplay`](#thread-replay) - Replay recorded conversations with playback controls
- [`useThreadRecorder`](#use-thread-recorder) - Record live conversations for later replay
- [`PlaybackControls`](#playback-controls) - Playback UI with play/pause, speed control, and seeking
- [`diffMessages`](#diff-messages) - Compute diffs between message arrays for recording
