      ...
      children: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: "(messages: UIMessage[]) => boolean",
              description:
                "Optional callback to automatically send messages. Use with `lastAssistantMessageIsCompleteWithToolCalls` from 'ai' for automatic tool execution.",
            },
          ],
        },
      ],
