...
<ParametersTable
  ...
  parameters={[
    {
      name: "children",
      type: "(value: { attachment: Attachment }) => ReactNode",
      description: "Render function called for each attachment. Receives the attachment object.",
    },
    {
      name: "components",
      type: "ComposerAttachmentsComponents",
      description: "The component to render for each attachment. Deprecated in favor of children render function.",
      children: [
        {
