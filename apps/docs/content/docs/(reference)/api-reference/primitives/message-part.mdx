...
Message parts are usually one of text, reasoning, audio, file, tool-call, or data.
...
File content from assistant responses, such as generated images, PDFs, or other documents. See the [File component](/docs/ui/file) for rendering file parts.
