...
<Callout>
Looking to give the AI control over persistent UI state outside the chat? Check out [Interactables](/docs/guides/interactables) — they auto-generate tools that let the AI read and update component state.
</Callout>
