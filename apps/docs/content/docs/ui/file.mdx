...
Some models (like Google Gemini) generate images and files inline in responses. With `@assistant-ui/react-ai-sdk`, these are automatically converted to `FileMessagePart` objects.
...
For images, use the [Image](/docs/ui/image) component instead.
